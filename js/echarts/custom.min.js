...
if($("#status_chart2").length){
  ...
  var completed = [];
   for(let i = 0, l = parsedData22.length; i < l; i++) {
    ...
    if(parsedData22[i].values[0].key == "Ongoing"){
		ongoing.push(parsedData22[i].values[0].value);
		} else {
           completed.push(parsedData22[i].values[0].value);
                  }
     if(parsedData22[i].values[1].key == "Completed"){
		completed.push(parsedData22[i].values[1].value);
		} else {
           ongoing.push(parsedData22[i].values[1].value);
                  }
...
var f=echarts.init(document.getElementById("rcon_chart2"),a);f.setOption({title:{text:"RConsortium",subtext:"Number of Projects Per Year"},color:["#005479"], tooltip:{trigger:"axis"},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",data: years}],yAxis:[{type:"value"}],series:[{name:"Number of Projects",type:"bar",smooth:!1,itemStyle:{normal:{areaStyle:{type:"default"}}},data:counts}]})
...
for(let i = 0, l = parsedData.length; i < l; i++) {
    ...
    groups.push(parsedData[i].value);
   }  
//console.log(chapters);

var c1=echarts.init(document.getElementById("rugs_country_chart"),a);c1.setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Funded R User Groups"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",axisLabel:{
      rotate:50,interval:0
    }, boundaryGap:!0,data:countries  }],yAxis:[{type:"value"}],series:[{name:"Number of Funded R User Groups",type:"bar",smooth:!1, itemStyle:{}, data:groups    }]});
    $(window).on('resize', function(){
  c1.resize();
});

if($("#grant_pie1").length){
  ...
  var grant = [];
   ...
   for(let i = 0, l = parsedData.length; i < l; i++) {
    grant.push(parsedData[i].name);
   }  
  

var h=echarts.init(document.getElementById("grant_pie1"),a);h.setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data: grant },toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Number of Groups",type:"pie",radius:[45,150],center:["50%",170],x:"50%",max:40,sort:"ascending",data: JSON.parse(dat3) }]})
...
var grant_level = [];
 var grant_amt = [];
   ...
   for(let i = 0, l = parsedData.length; i < l; i++) {
    grant_level.push(parsedData[i].name);
   }  
  //console.log(grant_level);
vector = parsedData[2].value *150;
matrix = parsedData[1].value *500;
array = parsedData[0].value*1000;

// RC gives vector groups $150, matrix $500 and array $1000
grant_amt = [array,matrix,vector];


var c1=echarts.init(document.getElementById("grant_bar"),a);c1.setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Amount in USD"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",axisLabel:{
      interval:0
    }, boundaryGap:!0,data:grant_level  }],yAxis:[{type:"value"}],series:[{name:"Amount in USD",type:"bar",smooth:!1, itemStyle:{}, data:grant_amt    }]});
...
// events d3 call
d3.csv("data/events.csv").then(function(data) {
 var cleandata = data.map(function(d) {
    var cleanD = {};
    d3.keys(d).forEach(function(k) {
      cleanD[_.trim(k)] = _.trim(d[k]);
...
for(let i = 0, l = parsedData.length; i < l; i++) {
    countries.push(parsedData[i].key);
    conf.push(parsedData[i].value);
   }  
//console.log(chapters);

var c1=echarts.init(document.getElementById("events_country_chart"),a);c1.setOption({title:{text:"",subtext:""},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Funded Events"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",axisLabel:{
      rotate:50,interval:0
    }, boundaryGap:!0,data:countries  }],yAxis:[{type:"value"}],series:[{name:"Number of Funded Events",type:"bar",smooth:!1, itemStyle:{}, data:conf    }]});
    $(window).on('resize', function(){
  c1.resize();
});
...
if($("#event_city").length){
  ...
  var city = [];
   ...
   for(let i = 0, l = parsedData.length; i < l; i++) {
    city.push(parsedData[i].name);
   }  
  

var h=echarts.init(document.getElementById("event_city"),a);h.setOption({tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data: city },toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Number of Events",type:"pie",radius:[45,150],center:["50%",170],roseType:"area",x:"50%",max:40,sort:"ascending",data: JSON.parse(dat3) }]})
