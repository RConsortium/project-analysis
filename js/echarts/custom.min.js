...
var f=echarts.init(document.getElementById("rcon_chart2"),a);f.setOption({title:{text:"RConsortium",subtext:"Yearly Spending on Projects"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Projects","Total Funding, USD"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data: years}],yAxis:[{type:"value"}],series:[{name:"Number of Projects",type:"line",smooth:!1,itemStyle:{normal:{areaStyle:{type:"default"}}},data:counts},{name:"Total Funding, USD",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data: year_amt }]})
