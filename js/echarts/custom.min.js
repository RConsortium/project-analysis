...
var f=echarts.init(document.getElementById("rcon_chart"),a);f.setOption({title:{text:"RConsortium",subtext:"Yearly-Quarterly Spending on Projects"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Total Funding, USD","Number of Projects"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar",stack:"Stack"},type:["line","bar","stack"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data: yearq }],yAxis:[{type:"value"}],series:[{name:"Total Funding, USD",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:total_amt},{name:"Number of Projects",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data: countsq }]})
...
var j=echarts.init(document.getElementById("echart_pie_fundlevel"));j.setOption({title:{text:"Funding Level, USD",subtext:"By Number of Projects"},tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["$10,000 and Below","$10,000 - $20,000","$20,000 - $30,000","Above $30,000"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"left",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Number of Projects",type:"pie",radius:"75%",center:["50%","48%"],data:[{value:less10k, name:"$10,000 and Below"},{value:less20k,name:"$10,000 - $20,000"},{value:less30k,name:"$20,000 - $30,000"},{value:above30k,name:"Above $30,000"}]}]});var k={normal:{label:{show:!1},labelLine:{show:!1}}},l={normal:{color:"rgba(0,0,0,0)",label:{show:!1},labelLine:{show:!1}},emphasis:{color:"rgba(0,0,0,0)"}}

});
}

if($("#invchart_donut").length){var i=echarts.init(document.getElementById("invchart_donut"),a);i.setOption({title:{text:"Top Primary Investigators",subtext:"By Number of Projects"},tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},calculable:!0,legend:{x:"center",y:"bottom",data:["Kirill Muller","Edzer Pebesma","Gabor Csardi","Jeroen Ooms"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"center",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},series:[{name:"Number of Projects",type:"pie",radius:["35%","55%"],itemStyle:{normal:{label:{show:!0},labelLine:{show:!0}},emphasis:{label:{show:!0,position:"center",textStyle:{fontSize:"14",fontWeight:"normal"}}}},data:[{value:4,name:"Kirill Muller"},{value:3,name:"Edzer Pebesma"},{value:2,name:"Gabor Csardi"},{value:2,name:"Jeroen Ooms"}]}]})}
...
d3.csv("https://raw.githubusercontent.com/benubah/rconsortium_projects/master/projects.csv").then(function(data) {
  ...
  .entries(cleandata);
   ...
   dat5 = JSON.stringify(numberproj).replace(/key/g, 'name').replace(/Q/g, 'Quarter ');
...
var h=echarts.init(document.getElementById("echart_pie_q"),a);h.setOption({title:{text:"All Quarters",subtext:"Grouped By Number of Projects"},tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data: quarter },toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Number of Projects",type:"pie",radius:[45,140],center:["50%",170],roseType:"area",x:"50%",max:40,sort:"ascending",data: JSON.parse(dat5) }]})
});
...
var f=echarts.init(document.getElementById("rcon_chart2"),a);f.setOption({title:{text:"RConsortium",subtext:"Yearly Spending on Projects"},tooltip:{trigger:"axis"},legend:{x:220,y:40,data:["Number of Projects","Total Funding, USD"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",boundaryGap:!1,data: years}],yAxis:[{type:"value"}],series:[{name:"Number of Projects",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data:counts},{name:"Total Funding, USD",type:"line",smooth:!0,itemStyle:{normal:{areaStyle:{type:"default"}}},data: year_amt }]})
...
var ft=echarts.init(document.getElementById("status_chart"));
ft.setOption({title:{text:"Project Status",subtext:"By Number of Projects"},tooltip:{trigger:"axis"},legend:{data:["Number of Projects"]},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",data: staty}],yAxis:[{type:"value"}],series:[{name:"Number of Projects",type:"bar",data:countsy }]})
