...
var f=echarts.init(document.getElementById("rcon_chart2"),a);f.setOption({title:{text:"RConsortium",subtext:"Number of Projects Per Year"},color:["#BDC3C7"], tooltip:{trigger:"axis"},toolbox:{show:!0,feature:{magicType:{show:!0,title:{line:"Line",bar:"Bar"},type:["line","bar"]},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,xAxis:[{type:"category",data: years}],yAxis:[{type:"value"}],series:[{name:"Number of Projects",type:"bar",smooth:!1,itemStyle:{normal:{areaStyle:{type:"default"}}},data:counts}]})
