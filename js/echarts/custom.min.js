...
var j2=echarts.init(document.getElementById("echart_pie_fundlevel2"),a);j2.setOption({title:{text:"Funds Distribution",subtext:"Across Funding Levels"},color:[  "#4ca0c6",'#bda29a','#6e7074', '#546570', '#c4ccd3'],tooltip:{trigger:"item",formatter:"{a} <br/>{b} : {c} ({d}%)"},legend:{x:"center",y:"bottom",data:["$10k and Below","$10k - $20k","$20k - $30k","Above $30k"]},toolbox:{show:!0,feature:{magicType:{show:!0,type:["pie","funnel"],option:{funnel:{x:"25%",width:"50%",funnelAlign:"left",max:1548}}},restore:{show:!0,title:"Restore"},saveAsImage:{show:!0,title:"Save Image"}}},calculable:!0,series:[{name:"Cumulative Amount USD",type:"pie",radius:[45,150],center:["50%","48%"],data:[{value:less10k, name:"$10k and Below"},{value:less20k,name:"$10k - $20k"},{value:less30k,name:"$20k - $30k"},{value:above30k,name:"Above $30k"}]}]});var k={normal:{label:{show:!1},labelLine:{show:!1}}},l={normal:{color:"rgba(0,0,0,0)",label:{show:!1},labelLine:{show:!1}},emphasis:{color:"rgba(0,0,0,0)"}}
